...
export default function AirlanggaNavbar() {
  const [isOpen, setIsOpen] = useState(false)
  const pathname = usePathname()

  const AirlanggaNavItems = [
    { name: 'Home', href: '/' },
      ...
      <div className="airlangga-container">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:block">
            <Link href="/contact" className="airlangga-button-primary text-sm">
              Hire Me
            </Link>
          </div>
            ...
            <div className="flex flex-col space-y-2">
              ...
              <div className="px-4 pt-2">
                <Link 
                  href="/contact" 
                  onClick={() => setIsOpen(false)}
                  className="airlangga-button-primary w-full text-center text-sm"
                >
                  Hire Me
                </Link>
              </div>
