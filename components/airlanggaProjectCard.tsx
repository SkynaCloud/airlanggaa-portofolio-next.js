...
interface AirlanggaProjectProps {
  project: {
    id: number
    title: string
    description: string
...
export default function AirlanggaProjectCard({ project }: AirlanggaProjectProps) {
  const statusColors = {
  ...
  return (
    <div className="airlangga-card overflow-hidden group">
      {/* Project Image */}
